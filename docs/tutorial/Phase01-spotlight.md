...
| 6 | `#slots` | 키 1 또는 슬롯을 클릭해 발사하세요 | 전투 중 마나 감소 감지 |
| 7 | `#speedControls` | 배속 버튼으로 게임을 빠르게 진행할 수 있습니다 (Z/X/C/V) | 배속 버튼 클릭 |
| 8 | 없음 (중앙 카드) | 기지 함락. 설계판으로 돌아가 더 강한 술식을 만들어보세요 | [설계 화면으로] 버튼 클릭 |
